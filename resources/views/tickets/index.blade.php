        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('ticket.index', ['filter' => 'all']) }}" class="btn btn-success">Semua Tiket</a>
                    <a href="{{ route('ticket.index', ['filter' => 'guru_kosong']) }}" class="btn btn-danger">Guru Kosong</a>
                </div>
                        ...
                        <tbody>
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ticketDetailModal{{ $ticket->id }}">View</button>
                                        <a href="{{ route('ticket.edit', $ticket->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $ticket->id }}">Delete</button>                                    
                                    </td>
                                </tr>
